...
Go (Golang), React, React Native, AWS, Google Cloud, Kubernetes, Terraform, CI/CD, Docker, Bash, SQL, Git, Shell, Javascript.<br>
...
**Stack:** Go, Commercetools, Svelte, Protobuf, Bash, GCP, Adyen
